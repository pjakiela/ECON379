...
graph export linear-resp1.pdf, replace
...
graph export linear-resp2.pdf, replace
...
graph export linear-resp3.pdf, replace
...
tw ///
	...
	text(-0.4 0.25 "comparison", color(vermillion) place(n) size(large)) ///
	text(-0.4 0.75 "treatment", color(sea) place(n) size(large)) 
graph export linear-resp4.pdf, replace
...
tw ///
	...
	text(-0.4 0.25 "comparison", color(vermillion) place(n) size(large)) ///
	text(-0.4 0.75 "treatment", color(sea) place(n) size(large)) 
graph export linear-resp5.pdf, replace
...
graph export linear-resp-explain.pdf, replace
